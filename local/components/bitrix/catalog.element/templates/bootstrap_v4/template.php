...
?>
                                    ...
                                    <div class="checkbox">
                                        <label class="m-0" id="<?= $itemIds['COMPARE_LINK'] ?>">
                                            ...
                                            if (isset($_SESSION["CATALOG_COMPARE_LIST"][$iblockid]["ITEMS"][$id])) {
                                                $checked = 'checked';
                                                $compareText = 'Уже в сравнении';
                                            } else {
                                                $checked = '';
                                                $compareText = 'Сравнить';
                                            }
                                            ?>
                                            <input <?= $checked; ?> data-entity="compare-checkbox" type="checkbox" id="compareid_<?= $arResult['ID']; ?>" onchange="toggleCompareText(<?= $arResult['ID']; ?>);" onclick="compare_tov(<?= $arResult['ID']; ?>);">
                                            <span data-entity="compare-title"><?= $compareText; ?></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function toggleCompareText(id) {
            // Получение элемента span с помощью селектора атрибута id
            var compareTitle = document.querySelector('#compareid_' + id + ' + span[data-entity="compare-title"]');

            // Проверка состояния чекбокса
            if (document.getElementById('compareid_' + id).checked) {
                compareTitle.innerText = 'Добавлен ';
            } else {
                compareTitle.innerText = 'Сравнить';
            }
        }
    </script>
<?
